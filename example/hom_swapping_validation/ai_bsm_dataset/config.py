"""Configuration helpers for BSM-only AI diagnosis dataset generation."""
...
@dataclass(frozen=True)
class SetupConfig:
    setup_id: str = "bsm_reference_40km"
...
class GenerationConfig:
    dataset_name: str = "bsm_ai_sample"
    dataset_size: int = 18
...
class SlurmConfig:
    ...
    array_tasks: int = 1
    python_cmd: str = "/home/ana35/.venvs/sequence-bsm/bin/python"
