...
- central HOM beam splitter with two output detectors
...
```bash
python example/hom_validation/run_hom_three_overlap_batch.py
```
...
```bash
python example/hom_validation/run_hom_three_overlap_batch.py --config example/hom_validation/configs/my_temporal_config.ini
```
